...
('Giulianna Rondineli Carmassi', 'giulianna@ufscar.br', 'Doutora'),
('Henrique Carmona Duval', 'henriquecarmona@ufscar.br', 'Doutor'),
('Marcos Arduin', 'darduin@ufscar.br', 'Doutor'),
('Leonardo Maurici Borges', 'aquitemcaqui@gmail.com', 'Doutor'),
('Andréa Lúcia Teixeira de Souza', 'altdesouza@ufscar.br', 'Doutora'),
('Victor Satoru Saito', 'vssaito@ufscar.br', 'Doutor'),
('Wladimir Rafael Beck', 'beckwr@ufscar.br', 'Doutor'),
('Diana Amaral Monteiro', 'dianamonteiro@ufscar.br', 'Doutora'),
('Patrícia Domingues de Freitas', 'patdf@ufscar.br', 'Doutora'),
('Maria Teresa Marques Novo Mansur', 'marinovo@ufscar.br', 'Doutora'),
('Reinaldo José de Castro', 'reinaldocastro@ufscar.br', 'Doutor'),
('Gilmar Perbiche Neves', 'gpneves@ufscar.br', 'Doutor'),
('Clovis Wesley Oliveira de Souza', 'clovis@ufscar.br', 'Doutor'),
...
('Amanda Dourado Souza Akahosi Fernandes', 'amandafernandes@ufscar.br', 'Doutora'),
('Lívia Celegati Pan', 'liviapan@ufscar.br', 'Doutora'),
('Silvana Gama Florêncio Chachá', 'silvanachacha@ufscar.br', 'Doutora'),
('Augustus Tadeu Relo de Mattos', 'augustus@ufscar.br', 'Doutor'),
('Letícia Pimenta Costa-Guarisco', 'lepcosta@ufscar.br', 'Doutora'),
('Juliana Hotta Ansai', 'jhansai@ufscar.br', 'Doutora'),
('Valter Vieira de Camargo', 'valtervcamargo@ufscar.br', 'Doutor'),
('Marcela Xavier Ribeiro', 'marcelaxr@ufscar.br', 'Doutora'),
('Fernando Menezes de Almeida Filho', 'almeidafilho@ufscar.br', 'Doutor'),
('Francis Massashi Kakuda', 'francis@ufscar.br', 'Doutor'),
('Robson Barcellos', 'rbarcellos@ufscar.br', 'Doutor'),
('Helder Vinicius Avanço Galeti', 'helder@ufscar.br', 'Doutor'),
('Armando Ítalo Sette Antonialli', 'antonialli@ufscar.br', 'Doutor'),
('João Vitor de Carvalho Fontes', 'joaofontes@ufscar.br', 'Doutor'),
('Rodrigo Bresciani Canto', 'rbcanto@ufscar.br', 'Doutor'),
('Luiz Antonio Pessan', 'pessan@ufscar.br', 'Doutor'),
('Silvio Eduardo Alvarez Candido', 'seacandido@ufscar.br', 'Doutor'),
('Clarissa Fullin Barco de Camargo', 'clarissa@dep.ufscar.br', 'Doutora'),
('Gabriela Cantarelli Lopes', 'gclopes@ufscar.br', 'Doutora'),
('Rodrigo Béttega', 'bettega@ufscar.br', 'Doutor'),
('Luis Ernesto Bueno Salasar', 'luis@ufscar.br', 'Doutor'),
('Teresa Cristina Martins Dias', 'dtmd@ufscar.br', 'Doutora'),
('Emanuel Fernandes de Lima', 'eflima@ufscar.br', 'Doutor'),
('Francisco Ednilson Alves dos Santos', 'santos@ufscar.br', 'Doutor'),
('Emerson Rodrigues de Camargo', 'camargo@ufscar.br', 'Doutor'),
('Manoel Gustavo Petrucelli Homem', 'mghomem@ufscar.br', 'Doutor'),
('Neila Conceição Cunha Nardy', 'neila@ufscar.br', 'Doutora'),
('Maria Cristina Comunian Ferraz', 'cristina@ufscar.br', 'Doutora'),
('Siovani Cintra Felipussi', 'siovani@ufscar.br', 'Doutor'),
('Yeda Regina Venturini', 'yeda@ufscar.br', 'Doutora'),
('Alexandre Lopes Gomes', 'algomes@ufscar.br', 'Doutor'),
('Rosane Nunes de Faria', 'rnfaria@ufscar.br', 'Doutora'),
('Juliana Rezende Torres', 'julianart@ufscar.br', 'Doutora'),
('Débora Dainez', 'ddainez@ufscar.br', 'Doutora'),
('José Marcos Nayme Novelli', 'novelli@ufscar.br', 'Doutor'),
('José Eduardo de Salles Roselino Junior', 'jeroselino@ufscar.br', 'Doutor'),
('Augusto João Piratelli', 'piratelli@ufscar.br', 'Doutor'),
('Cláudio Roberto Thiersch', 'crthiersch@ufscar.br', 'Doutor'),
('Johnny Vilcarromero Lopez', 'jvlopez@ufscar.br', 'Doutor'),
('Antonio Luis Venezuela', 'alvenez@ufscar.br', 'Doutor'),
('Luciana de Souza Gracioso', 'luciana@ufscar.br', 'Doutora'),
('Luzia Sigoli Fernandes Costa', 'luziasigoli@ufscar.br', 'Doutora'),
('Marcos Pazzanese Duarte Lanna', 'mlanna@ufscar.br', 'Doutor'),
('Flavio Caetano da Silva', 'flaviocaetano@ufscar.br', 'Doutor'),
('Renata Maria Moschen Nascente', 'renatanascente@ufscar.br', 'Doutora'),
('Camila da Silva Alavarce', 'camilaalavarce@ufscar.br', 'Doutora'),
('Rosa Yokota', 'ryokota@ufscar.br', 'Doutora'),
('Joceli Catarina Stassi Sé', 'jocelistassise@ufscar.br', 'Doutora'),
('Iraí Maria de Campos Teixeira', 'irai@ufscar.br', 'Doutora'),
('Rosemeire de Araújo Rangni', 'rose.rangni@ufscar.br', 'Doutora'),
('Elizabeth Joan Barham', 'lisa@ufscar.br', 'Doutora'),
('Fabiana Luci de Oliveira', 'fabianaluci@ufscar.br', 'Doutora'),
('Aline Suelen Pires', 'alinepires@ufscar.br', 'Doutora'),
('Andrea Braga Moruzzi', 'andreamoruzzi@ufscar.br', 'Doutora'),
('Rebeca Chiacchio Azevedo Fernandes Galletti', 'rebeca.fernandes@ufscar.br', 'Doutora'),
('Josiane Rodrigues', 'josirodrigues@ufscar.br', 'Doutora'),
('Sabrina Gabardo', 'sabrinagabardo@ufscar.br', 'Doutora');
...
--- inserção dos campus ---
INSERT INTO campus (nome, reitoria_id, localizacao, endereco) VALUES ('Campus São Carlos', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), NULL, 'Rod. Washington Luís km 235 - SP-310 - São Carlos'); 
INSERT INTO campus (nome, reitoria_id, localizacao, endereco) VALUES ('Campus Araras', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), NULL, 'Rod. Anhanguera km 174 - SP-330 - Araras'); 
INSERT INTO campus (nome, reitoria_id, localizacao, endereco) VALUES ('Campus Sorocaba', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), NULL, 'Rod. João Leme dos Santos km 110 - SP-264 Bairro do Itinga - Sorocaba'); 
INSERT INTO campus (nome, reitoria_id, localizacao, endereco) VALUES ('Campus Lagoa do Sino', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), NULL, 'Rod. Lauri Simões de Barros km 12 - SP-189 Bairro Aracaçu - Buri'); 

--- inserções pro_reitoria ---
INSERT INTO pro_reitoria(sigla_preitoria, reitoria_id, nome)
VALUES
('ProGrad', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Pró-Reitoria de Graduação'),
('ProPG', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Pró-Reitoria de Pós-Graduação'),
('ProPq', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Pró-Reitoria de Pesquisa'),
('ProEx', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Pró-Reitoria de Extensão'),
('ProGPe', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Pró-Reitoria de Gestão de Pessoas'),
('ProACE', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Pró-Reitoria de Assuntos Comunitários e Estudantis'),
('ProAd', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Pró-Reitoria de Administração');

--- inserções reitoria_professor ---
INSERT INTO reitoria_professor (prof_id, reitoria_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), '2020', '2024', 'Reitora' FROM professor WHERE nome='Ana Beatriz de Oliveira');

INSERT INTO reitoria_professor (prof_id, reitoria_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), '2021', '2025', 'Vice-Reitora' FROM professor WHERE nome='Maria de Jesus Dutra dos Reis');
...
VALUES ('CCET', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Centro de Ciências Exatas e de Tecnologia', NULL, '16 3351-8201'),
('CCBS', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Centro de Ciências Biológicas e da Saúde', NULL, '16 3351-8301'),
('CECH', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Centro de Educação e Ciências Humanas', NULL, '16 3351-8351'),
('CCGT', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Centro de Ciências em Gestão e Tecnologia', NULL, '15 3229-7546'),
('CCHB', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Centro de Ciências Humanas e Biológicas', NULL, '15 3229-7470'),
('CCTS', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Centro de Ciências e Tecnologias para Sustentabilidade', NULL, '15 3329-5937'),
('CCA', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Centro de Ciências Agrárias', NULL, '19 3543-2600'),
('CCN', (SELECT reitoria_id FROM reitoria WHERE email = 'reitoria@ufscar.br'), 'Centro de Ciências da Natureza', NULL, NULL);

--- inserções centro_professor ---
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, '2018', '2022', 'diretora' FROM professor p, centro c WHERE p.nome = 'Maria da Graça Gama Melão'AND c.sigla_centro = 'CCBS');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, '2018', '2022', 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Isabela Aparecida de Oliveira Lussi'AND c.sigla_centro = 'CCBS');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, NULL, NULL, 'diretor' FROM professor p, centro c WHERE p.nome = 'Luiz Fernando de Oriani e Paulillo'AND c.sigla_centro = 'CCET');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, NULL, NULL, 'vice-diretor' FROM professor p, centro c WHERE p.nome = 'Guillermo Antonio Lobos Villagra'AND c.sigla_centro = 'CCET');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, '2018', '2022 ', 'diretor' FROM professor p, centro c WHERE p.nome = 'Rodrigo Vilela Rodrigues'AND c.sigla_centro = 'CCGT');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, '2018', '2022 ', 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Monica Fabiana Bento Moreira Thiersch'AND c.sigla_centro = 'CCGT');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, '2022', '2026 ', 'diretor' FROM professor p, centro c WHERE p.nome = 'André Cordeiro Alves dos Santos'AND c.sigla_centro = 'CCHB');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, '2022', '2026 ', 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Maria Walburga dos Santos'AND c.sigla_centro = 'CCHB');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, NULL, NULL, 'diretora' FROM professor p, centro c WHERE p.nome = 'Ana Lúcia Brandl'AND c.sigla_centro  = 'CCTS');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, NULL, NULL, 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Marystela Ferreira'AND c.sigla_centro = 'CCTS');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, '2020', '2024 ', 'diretora' FROM professor p, centro c WHERE p.nome = 'Ana Cristina Juvenal da Cruz'AND c.sigla_centro = 'CECH');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, '2020', '2024 ', 'vice-diretor' FROM professor p, centro c WHERE p.nome = 'Adélcio Camilo Machado'AND c.sigla_centro = 'CECH');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, NULL, NULL, 'diretor' FROM professor p, centro c WHERE p.nome = 'Ricardo Toshio Fujihara'AND c.sigla_centro = 'CCA');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, NULL, NULL, 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Adriana Cavalieri Sais'AND c.sigla_centro = 'CCA');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, NULL, NULL, 'diretor' FROM professor p, centro c WHERE p.nome = 'Giulianna Rondineli Carmassi'AND c.sigla_centro = 'CCN');
INSERT INTO centro_professor (prof_id, centro_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, centro_id, NULL, NULL, 'diretor' FROM professor p, centro c WHERE p.nome = 'Henrique Carmona Duval'AND c.sigla_centro = 'CCN');
...
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Marcos Arduin' AND d.dept_sigla = 'DB');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Leonardo Maurici Borges' AND d.dept_sigla = 'DB');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Andréa Lúcia Teixeira de Souza' AND d.dept_sigla = 'DCAm');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Victor Satoru Saito' AND d.dept_sigla = 'DCAm');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Wladimir Rafael Beck' AND d.dept_sigla = 'DCF');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Diana Amaral Monteiro' AND d.dept_sigla = 'DCF');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Patrícia Domingues de Freitas' AND d.dept_sigla = 'DGE');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Maria Teresa Marques Novo Mansur' AND d.dept_sigla = 'DGE');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Reinaldo José de Castro' AND d.dept_sigla = 'DHb');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Gilmar Perbiche Neves' AND d.dept_sigla = 'DHb');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Clovis Wesley Oliveira de Souza' AND d.dept_sigla = 'DMP');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Maíra Aparecida Stefanini' AND d.dept_sigla = 'DMP');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Daniela Godoi Jacomassi' AND d.dept_sigla = 'DEFMH');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Cleiton Augusto Libardi' AND d.dept_sigla = 'DEFMH');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Ariene Angelini dos Santos Orlandi' AND d.dept_sigla = 'DEnf');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Jamile Claro de Castro Bussadori' AND d.dept_sigla = 'DEnf');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Anna Carolyna L. Gianlorenço' AND d.dept_sigla = 'DFisio');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Luiz Fernando A. Selistre' AND d.dept_sigla = 'DFisio');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Amanda Dourado Souza Akahosi Fernandes' AND d.dept_sigla = 'DTO');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Lívia Celegati Pan' AND d.dept_sigla = 'DTO');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Silvana Gama Florêncio Chachá' AND d.dept_sigla = 'DMed');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Augustus Tadeu Relo de Mattos' AND d.dept_sigla = 'DMed');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Letícia Pimenta Costa-Guarisco' AND d.dept_sigla = 'DGero');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Juliana Hotta Ansai' AND d.dept_sigla = 'DGero');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2021, 2022, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Valter Vieira de Camargo' AND d.dept_sigla = 'DC');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2021, 2022, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Marcela Xavier Ribeiro' AND d.dept_sigla = 'DC');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Fernando Menezes de Almeida Filho' AND d.dept_sigla = 'DECiv');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Francis Massashi Kakuda' AND d.dept_sigla = 'DECiv');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2022, 2024, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Robson Barcellos' AND d.dept_sigla = 'DEE');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2022, 2024, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Helder Vinicius Avanço Galeti' AND d.dept_sigla = 'DEE');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Armando Ítalo Sette Antonialli' AND d.dept_sigla = 'DEMec');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'João Vitor de Carvalho Fontes' AND d.dept_sigla = 'DEMec');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Rodrigo Bresciani Canto' AND d.dept_sigla = 'DEMa');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Luiz Antonio Pessan' AND d.dept_sigla = 'DEMa');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Silvio Eduardo Alvarez Candido' AND d.dept_sigla = 'DEP');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Clarissa Fullin Barco de Camargo' AND d.dept_sigla = 'DEP');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Gabriela Cantarelli Lopes' AND d.dept_sigla = 'DEQ');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Rodrigo Béttega' AND d.dept_sigla = 'DEQ');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2022, 2024, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Luis Ernesto Bueno Salasar' AND d.dept_sigla = 'DEs');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2022, 2024, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Teresa Cristina Martins Dias' AND d.dept_sigla = 'DEs');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Emanuel Fernandes de Lima' AND d.dept_sigla = 'DF');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Francisco Ednilson Alves dos Santos' AND d.dept_sigla = 'DF');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Emerson Rodrigues de Camargo' AND d.dept_sigla = 'DQ');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Manoel Gustavo Petrucelli Homem' AND d.dept_sigla = 'DQ');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Neila Conceição Cunha Nardy' AND d.dept_sigla = 'DAdm-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Maria Cristina Comunian Ferraz' AND d.dept_sigla = 'DAdm-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2021, 2023, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Siovani Cintra Felipussi' AND d.dept_sigla = 'DComp-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2021, 2023, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Yeda Regina Venturini' AND d.dept_sigla = 'DComp-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Alexandre Lopes Gomes' AND d.dept_sigla = 'DEco-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Rosane Nunes de Faria' AND d.dept_sigla = 'DEco-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Juliana Rezende Torres' AND d.dept_sigla = 'DCHE-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Débora Dainez' AND d.dept_sigla = 'DCHE-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'José Marcos Nayme Novelli' AND d.dept_sigla = 'DGTH-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'José Eduardo de Salles Roselino Junior' AND d.dept_sigla = 'DGTH-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Augusto João Piratelli' AND d.dept_sigla = 'DCA-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Cláudio Roberto Thiersch' AND d.dept_sigla = 'DCA-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Johnny Vilcarromero Lopez' AND d.dept_sigla = 'DFQM-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Antonio Luis Venezuela' AND d.dept_sigla = 'DFQM-So');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Luciana de Souza Gracioso' AND d.dept_sigla = 'DCI');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Luzia Sigoli Fernandes Costa' AND d.dept_sigla = 'DCI');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Marcos Pazzanese Duarte Lanna' AND d.dept_sigla = 'DCSo');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Carolina Raquel Duarte de Mello Justo' AND d.dept_sigla = 'DCSo');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2022, 2023, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Flavio Caetano da Silva' AND d.dept_sigla = 'DEd');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, 2022, 2023, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Renata Maria Moschen Nascente' AND d.dept_sigla = 'DEd');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Camila da Silva Alavarce' AND d.dept_sigla = 'DL');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Rosa Yokota' AND d.dept_sigla = 'DL');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Joceli Catarina Stassi Sé' AND d.dept_sigla = 'DME');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Iraí Maria de Campos Teixeira' AND d.dept_sigla = 'DME');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Rosemeire de Araújo Rangni' AND d.dept_sigla = 'DPsi');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Elizabeth Joan Barham' AND d.dept_sigla = 'DPsi');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Fabiana Luci de Oliveira' AND d.dept_sigla = 'DS');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Aline Suelen Pires' AND d.dept_sigla = 'DS');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Andrea Braga Moruzzi' AND d.dept_sigla = 'DTPP');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Rebeca Chiacchio Azevedo Fernandes Galletti' AND d.dept_sigla = 'DTPP');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Josiane Rodrigues' AND d.dept_sigla = 'DTAiSER');
INSERT INTO departamento_professor (prof_id, dept_id, ano_inicio, ano_termino, cargo)
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Sabrina Gabardo' AND d.dept_sigla = 'DTAiSER');
...
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Ginásio de Esportes'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Campo de Futebol'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, 'Campo de Futebol 01'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, 'Campo de Futebol 02'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, 'Quadra Esportiva - Araras'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, 'Quadra Esportiva - Sorocaba'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Piscina Semi-Olímpica'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Piscina Aprendizagem'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Espaço de Convivência Área Sul'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Teatro de Bolso'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Quiosque Área Sul'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Quiosque I - Área Norte'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Quiosque II - Área Norte'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Sala de Ensaio da Orquestra'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Espaço Cultural');
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, 'Quiosque 1'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, 'Quiosque 2'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, 'Praça'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Bosque de Pinus da UFSCar'); 
INSERT INTO area (campus_id, localizacao, nome) VALUES ((SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, 'Represa do Rio Monjolinho'); 
...
INSERT INTO esporte (area_id, esporte_praticado) 
(SELECT area_id, 'Natação' FROM area a WHERE a.nome = 'Piscina Semi-Olímpica');

INSERT INTO esporte (area_id, esporte_praticado) 
(SELECT area_id, 'Natação' FROM area a WHERE a.nome = 'Piscina Aprendizagem'); 

INSERT INTO esporte (area_id, esporte_praticado) 
(SELECT area_id, 'Futebol' FROM area a WHERE a.nome = 'Campo de Futebol 01'); 

INSERT INTO esporte (area_id, esporte_praticado) 
(SELECT area_id, 'Futebol' FROM area a WHERE a.nome = 'Campo de Futebol 02'); 

INSERT INTO esporte (area_id, esporte_praticado) 
(SELECT area_id, 'Futebol, Vôlei, Basquete' FROM area a WHERE a.nome = 'Quadra Esportiva - Araras'); 

INSERT INTO esporte (area_id, esporte_praticado) 
(SELECT area_id, 'Futebol, Vôlei, Basquete' FROM area a WHERE a.nome = 'Quadra Esportiva - Sorocaba');

--- inserções lazer ---
INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Piscina Semi-Olímpica'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Piscina Aprendizagem'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Espaço de Convivência Área Sul'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Teatro de Bolso'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Quiosque Área Sul'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Quiosque I - Área Norte'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Quiosque II - Área Norte'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Sala de Ensaio da Orquestra'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Espaço Cultural'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Quiosque 1'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Quiosque 2'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Praça');

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Ginásio de Esportes'); 

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Campo de Futebol');

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Campo de Futebol 01');

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Campo de Futebol 02');

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Quadra Esportiva - Sorocaba');

INSERT INTO lazer (area_id, capacidade) 
(SELECT area_id, NULL FROM area a WHERE a.nome = 'Quadra Esportiva - Araras');

--- inserções reserva_natural ---
INSERT INTO reserva_natural (area_id, bioma) 
(SELECT area_id, 'Mata Atlântica' FROM area a WHERE a.nome = 'Bosque de Pinus da UFSCar'); 

INSERT INTO reserva_natural (area_id, bioma) 
(SELECT area_id, 'Mata Atlântica' FROM area a WHERE a.nome = 'Represa do Rio Monjolinho'); 
--- inserções construcao ---
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Biblioteca Comunitária / Teatro Florestan Fernandes');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Atendimento à Criança');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Atendimento à Criança - Ampliação');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Atendimento à Criança - Quadra');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Sanitários AT03');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Salas de Estudo em Grupo e Laboratório de Informática');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Simulação de Práticas Profissionais da Saúde');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Reservatório Área Sul');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Reservatório Área Norte');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Reservatório de Água - Área Norte (em frente ao Lamav)');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Central de Serviços Terceirizados');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Central de Resíduos - Amplicação');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Central de Resíduos - Depósito de Produtos Químicos');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Central de Resíduos - Depósito de Produtos Radioativos');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Central de Resíduos - Depósito de Material Reciclável');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Central de Resíduos - Administração');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Central de Resíduos - Depósito de Combustíveis'); 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Casa de Máquinas / Piscina');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Cabine de Elétrica (AEN)');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Pórtico de Acesso Washington Luís - Área Sul');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Pórtico de Acesso Norte - Área Norte');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Pórtico de Acesso Leste - Babilônia');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Anexo do Departamento de Morfologia e Patologia' FROM departamento d WHERE d.dept_sigla = 'DMP'); 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Anexo I – Departamento de Ecologia e Biologia Evolutiva' FROM departamento d WHERE d.dept_sigla = 'DEBE');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Anexo II – Departamento de Ecologia e Biologia Evolutiva' FROM departamento d WHERE d.dept_sigla = 'DEBE');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Anexo III – Departamento de Ecologia e Biologia Evolutiva' FROM departamento d WHERE d.dept_sigla = 'DEBE'); 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Anexo I – Departamento de Hidrobiologia' FROM departamento d WHERE d.dept_sigla = 'DHb');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Anexo II – Departamento de Hidrobiologia' FROM departamento d WHERE d.dept_sigla = 'DHb');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Arquivo de História Contemporânea');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Pesquisa e Documentação');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Coordenações de Cursos');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'SINTUFSCar');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Pavilhão de Acesso SINTUFSCar');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Programa de Pós-Graduação em Educação Especial');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Passarela Coberta entre A6 e A7' FROM departamento d WHERE d.dept_sigla = 'DFMC');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Sanitário Público');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Alojamento - Módulo III');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Alojamento - Módulo IV');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Alojamento - Módulo V');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Alojamento - Módulo VI');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Alojamento - Módulo VII');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Alojamento - Módulo VIII');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Alojamento - Módulo XV');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Conjunto de Salas de Aula Sul - Babilônia');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Conjunto de Salas de Aula Sul - Babilônia II');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Vestiário do Pavilhão de Ginástica / Laboratório Didático de Condicionamento Físico' FROM departamento d WHERE d.dept_sigla = 'DEFMH');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Pavilhão de Ginástica');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Secretaria de Informática');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Anfiteatro Área Norte – Bento Prado');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Sala de Apoio do Anfiteatro Área Norte – Bento Prado');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Vigilância - Guarita (Transfederônica)');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Universidade Aberta do Brasil');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Gabinete de Docentes e Laboratórios' FROM departamento d WHERE d.dept_sigla = 'DF');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Diretoria do Centro de Ciências Exatas e Tecnológicas');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Passarela - DF' FROM departamento d WHERE d.dept_sigla = 'DF');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Circulação DEP/DEQ' FROM departamento d WHERE d.dept_sigla = 'DEQ');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Passarelas DEQ' FROM departamento d WHERE d.dept_sigla = 'DEQ');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Passarela 1 e Sanitários' FROM departamento d WHERE d.dept_sigla = 'DEMa');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Passarela 2 e Sanitários' FROM departamento d WHERE d.dept_sigla = 'DEMa');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Livraria da EdUFSCar');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Passarela - DQ' FROM departamento d WHERE d.dept_sigla = 'DQ');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Passarela e Sanitários' FROM departamento d WHERE d.dept_sigla = 'DECiv');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Estação Climatológica' FROM departamento d WHERE d.dept_sigla = 'DECiv');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Banco do Brasil');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Caixa Eletrônico do Banco Santander (Área Sul)');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Banco Santander (Área Norte)');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Estação de Psicultura - DHb' FROM departamento d WHERE d.dept_sigla = 'DHb');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Anexo de Estação de Psicultura - DHb' FROM departamento d WHERE d.dept_sigla = 'DHb');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Programa de Pós-Graduação em Química' FROM departamento d WHERE d.dept_sigla = 'DQ');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Auditório do Programa de Pós-Graduação em Química' FROM departamento d WHERE d.dept_sigla = 'DQ');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Programa de Pós-Graduação em Engenharia Civil' FROM departamento d WHERE d.dept_sigla = 'DECiv');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'UAB');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Oficina Mecânica' FROM departamento d WHERE d.dept_sigla = 'DEMa');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Edifício da ALCOA' FROM departamento d WHERE d.dept_sigla = 'DEMa');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Edífico de Aulas Teóricas 4');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Edifício de Aulas Teóricas 10');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Edíficio de Aulas Teóricas 5');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Edifício de Aulas Teóricas 6');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Edifício de Aulas Teóricas 7');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Edifício de Aulas Teóricas 8');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Edifício de Aulas Teóricas 9');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Garagem (FAI)');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Centro de Reprodução Gráfica');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Extensão - UFSCar/ESCOLA');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Extensão (1) - Saúde');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Extensão (2) - Empresa');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Extensão (3) - Cidadania');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Extensão (4) - INCOOP');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Extensão (5) - Sala de Múltiplo Uso');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL,'Oficina do Baja' FROM departamento d WHERE d.dept_sigla = 'DEMa');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Saúde Escola Bloco 1 - Pólo de Capacitação Bloco 2 - Consultas');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Saúde Escola Bloco 3 - Unidade Apoio Programas Bloco 4 - Fisioterapia');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Saúde Escola Bloco 5 - Administração Bloco 6 - Oficinas');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Saúde Escola Bloco 7 - Serviços Bloco 8 - Atendimentos à Criança / UENAPES');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Unidade de Saúde Escola - Passarela');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo Multidisciplinar Integrado de Estudos, Formação e Intervenção em Economia Solidária - NuMI-EcoSol Antiga Incubadora Regional de Cooperativas Populares - INCOOP');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Rádio e TV / Coordenadoria de Comunicação Social');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Formação de Professores – Blocos A e C');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Fundação de Apoio Institucional');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Vivência Estudantil');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Vivência AEN');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'NULEEN');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Edifício Petrobrás');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Núcleo de Apoio à Pesquisa');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'INCT-HYMPAR');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Complexo de Laboratórios Multidisciplinares de Estudos Estratégicos e Avançados');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Centro de Inferência Aplicada – Departamento de Estatística'); 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL,'Fundação de Apoio Institucional – Etapa 2');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'Departamento de Estatística - Anexo' FROM departamento d WHERE d.dept_sigla = 'DEs');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'NET-PRE Anexo' FROM departamento d WHERE d.dept_sigla = 'DECiv'); 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'Central de GLP e Núcleo de Serviço' FROM departamento d WHERE d.dept_sigla = 'DEQ');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'Central de Gás Liquefeito de Petróleo' FROM departamento d WHERE d.dept_sigla = 'DEMa');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'Núcleos de Serviços' FROM departamento d WHERE d.dept_sigla = 'DQ'); 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'Depósitos de Produtos Químicos 01' FROM departamento d WHERE d.dept_sigla = 'DQ');  /*não tinha o número*/ 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'Depósito de Produtos Químicos 02' FROM departamento d WHERE d.dept_sigla = 'DQ');  /*não tinha o número*/ 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Auditório do Departamento de Educação Especial (REUNI – Etapa 3)'); /*não tinha o número*/ 
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'ADUFSCar');  

/*A PARTIR DAQUI É REFERENTE AO CAMPUS ARARAS - 2*/   

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Vestiário do Campo 01');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Vestiário do Campo 02');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Aula 01'); /*era só sala de aula*/   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Aula 02'); /*era só sala de aula*/   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Aula Microscopia 01'); /*era só sala de aula microscopia */   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Aula Microscopia 02'); /*era só sala de aula microscopia */   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Uso Residencial - Caseiro');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Grupo de Pesquisa e Trabalhos Agropecuários');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Grupo de Pesquisa e Trabalhos Agropecuários - Apoio');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Docentes 01'); /* era só sala de docentes */   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Docentes 02'); /* era só sala de docentes */   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Docentes 03'); /* era só sala de docentes */   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Docentes 04'); /* era só sala de docentes */   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Docentes 05'); /* era só sala de docentes */   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Sala de Docentes 06'); /* era só sala de docentes */   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Casa da Colônia - Uso dos Professores');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Casa da Colônia - Uso do Caseiro');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Casa da Colônia - Identificar Uso 01'); /*era só casa de colônia - identificar uso*/   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Casa da Colônia - Identificar Uso 02'); /*era só casa de colônia - identificar uso*/   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Casa da Colônia - Identificar Uso 03'); /*era só casa de colônia - identificar uso*/   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Casa da Colônia - Uso dos Funcionários da FAI');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Biblioteca Central');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Anexo - Biblioteca Central');    
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Ambulatório - A Construir');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Salas de Professores - Araras');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Auditório');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Portaria 01');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Portaria 02');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Balança');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL,'Edifício PMGCA');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Galpão de Máquinas da LaGEM');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Oficina Mecânica da LaGEM');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Biblioteca Setorial do Prédio Central - Edifício Gilberto Miller Azzi');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Coordenação do Curso de Biotecnologia - Edifício Gilberto Miller Azzi');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Coordenação do Curso de Engenharia Agronômica - Edifício Gilberto Miller Azzi');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Auditório - Edifício Gilberto Miller Azzi');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Salas de Aulas e Laboratórios de Informática');  

/*A PARTIR DAQUI É REFERENTE AO CAMPUS SOROCABA - 3*/   

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Área de Vivência');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Ampliação da Área de Vivência');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Aulas Teóricas AT02');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Ampliação Aulas Teóricas AT02');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Biblioteca');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Vestiários da Quadra');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Sala de Docentes');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Oficina de Ensino');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'NETC (Térreo)');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Edifício de Aulas Teóricas e Laboratórios');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Cabine AT LAB');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Ambulatório');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Ampliação Ambulatório');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Salas de Aulas AT01');    
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Ampliação Salas de Aulas AT01');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Passarela e Implantar');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Salas de Professores - Sorocaba');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Sindicato');
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Creche');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL,'Serviços de Apoio');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Agência Bancária');   

/*A PARTIR DAQUI É REFERENTE AO CAMPUS LAGOA DO SINO - 4*/   

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Bloco 02 – Docentes');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Bloco 03 – Salas de Aulas Teóricas 01 (AT1)');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Salas de Aulas Teóricas 02 (AT2) (antiga garagem de máquinas agrícolas)');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Serviço Terceirizado de Fotocopia (antigo posto)');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Ciclo Básico');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Bloco 01 - Laboratórios');  

/* LOCAIS QUE NAO SE ENCAIXAM LAGOA DO SINO*/   

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Silo Alvenaria Desativado');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Silo Metálico a');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Silo Metálico b');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Silo Metálico c');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Silo Metálico d');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Curral 01'); /*era só curral*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Curral 02'); /*era só curral*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Curral 03'); /*era só curral*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Igreja');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa 01'); /*era só casa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa 02'); /*era só casa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa 03'); /*era só casa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa 04'); /*era só casa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa 05'); /*era só casa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa 06'); /*era só casa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa 07'); /*era só casa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa 08'); /*era só casa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa de Bomba para Irrigação 01'); /* era só casa de bomba para irrigação*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa de Bomba para Irrigação 02'); /* era só casa de bomba para irrigação*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL,'Casa de Bomba para Irrigação 03'); /* era só casa de bomba para irrigação*/  

/*INSERÇÕES CONSTRUÇÃO -> PARTE DO ADMINISTRATIVO*/  

/*A PARTIR DAQUI É REFERENTE AO CAMPUS SÃO CARLOS - 1*/  

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Seção Administrativa Edifícios / Manutenção');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Seção de Urbanização (Garagem para Máquinas)');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Seção de Transportes');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Seção de Vigilância');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Seção de Móveis e Utensílios');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Seção de Pintura - PU');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Sala de Manutenção - PU');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Observatório');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Ambulatório AEN');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Desocupado Antiga Clínica de Fisioterapia');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Desocupado Antigo Laboratório de Neurociências');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Diretoria do Centro de Ciências Humanas');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Portal dos Professores / NEAB E NIASI');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Centrinho Desocupado DEnf');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Procuradoria Jurídica');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Escritório de Desenvolvimento Físico');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Prefeitura Universitária');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'PU - EDF - Ampliação');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Guarita Prefeitura Universitária');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Depósito Prefeitura Universitária');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Manutenção Elétrica - PU');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Oficina Mecânica / Eletrônica');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Cabine de Energia - SIn');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Casa de Máquinas - RU');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'Casa de Compressores 01' FROM departamento d WHERE d.dept_sigla = 'DQ');  /*era só casa de compressores*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), dept_id, NULL, 'Casa de Compressores 02' FROM departamento d WHERE d.dept_sigla = 'DQ');  /*era só casa de compressores*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Coordenadoria Especial do Meio Ambiente');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Divisão de Informática e Controle Acadêmico');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Editora EdUFSCar');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Edifício Anexo à Reitoria');   

/*A PARTIR DAQUI É REFERENTE AO CAMPUS ARARAS - 2*/   

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Diretoria Fundação de Apoio Institucional Administração Laboratórios Psicólogo Assistente Social');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Seção de Transportes / Garagem de Veículos e de Máquinas');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa de Vidro');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa de Madeira');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 01'); /*era só estufa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 02'); /*era só estufa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 03'); /*era só estufa*/   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 04'); /*era só estufa*/   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 05'); /*era só estufa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 06'); /*era só estufa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 07'); /*era só estufa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 08'); /*era só estufa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Estufa 09'); /*era só estufa*/  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Posto Meteorológico');   

/*A PARTIR DAQUI É REFERENTE AO CAMPUS SOROCABA - 3*/  

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Cabine de Energia');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Cabine de Comunicação');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Gestão Acadêmica');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Gestão Administrativa');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Guarita');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Pórtico (Cobertura)');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Ampliação da Cozinha do RU');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Poço Artesiano SAAE');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Reservatório de Água');   

/*A PARTIR DAQUI É REFERENTE AO CAMPUS LAGOA DO SINO - 4*/   

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Bloco 04 - Administração Central');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Guarita Armazém');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Armazém de Grãos');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Mina de Água');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Caixa de Água');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Reservatório Metálico de Água');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Garagem de Máquinas Agrícolas');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Abrigo de Gás');   
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Casa de força (desativada)');  

/*INSERÇÕES CONSTRUÇÃO -> PARTE DA ALIMENTACAO*/  

/*A PARTIR DAQUI É REFERENTE AO CAMPUS SÃO CARLOS*/  

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Restaurante Universitário - São Carlos');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus São Carlos'), NULL, NULL, 'Ampliação do Restaurante Universitário de São Carlos');  

/*A PARTIR DAQUI É REFERENTE AO CAMPUS ARARAS*/  

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Lanchonete');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Cantina');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Araras'), NULL, NULL, 'Restaurante Universitário - Araras');  

/*A PARTIR DAQUI É REFERENTE AO CAMPUS SOROCABA*/  

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Restaurante Universitário - Sorocaba');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Ampliação do Refeitório do RU de Sorocaba');  
INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Sorocaba'), NULL, NULL, 'Restaurante 2');  

 /*A PARTIR DAQUI É REFERENTE AO CAMPUS LAGOA DO SINO - 4*/  

INSERT INTO construcao (campus_id, dept_id, localizacao, nome) (SELECT (SELECT campus_id FROM campus c WHERE c.nome = 'Campus Lagoa do Sino'), NULL, NULL, 'Bloco 01 - Refeitório'); 
...
INSERT INTO apoio_academico (construcao_id, proposito) (SELECT construcao_id, 'Ambiente para reuniões, palestras e apresentações' FROM construcao c WHERE c.nome = 'Anfiteatro Área Norte – Bento Prado'); 
INSERT INTO apoio_academico (construcao_id, proposito) (SELECT construcao_id, 'Ambiente para reuniões, palestras e apresentações - sala de apoio' FROM construcao c WHERE c.nome = 'Sala de Apoio do Anfiteatro Área Norte – Bento Prado');
...
INSERT INTO apoio_academico (construcao_id, proposito) (SELECT construcao_id, 'Conexão de caminhos' FROM construcao c WHERE c.nome = 'Passarela - DF');
...
INSERT INTO apoio_academico (construcao_id, proposito) (SELECT construcao_id, 'Conexão de caminhos' FROM construcao c WHERE c.nome = 'Passarela - DQ');
...
INSERT INTO apoio_academico (construcao_id, proposito) (SELECT construcao_id, 'Sala de Professor' FROM construcao c WHERE c.nome = 'Salas de Professores - Araras');  
...
INSERT INTO apoio_academico (construcao_id, proposito) (SELECT construcao_id, 'Salas para os professores' FROM construcao c WHERE c.nome = 'Salas de Professores - Sorocaba'); 
...
(SELECT construcao_id, 'De segunda à sexta-feira das 11h15 às 13h30 e das 17h15 às 19h00. De sábado das 11h30 às 13h00 - RU' FROM construcao c WHERE c.nome = 'Restaurante Universitário - São Carlos'); 

INSERT INTO alimentacao (construcao_id, horario_funcionamento)
(SELECT construcao_id, 'De segunda à sexta-feira das 11h15 às 13h30 e das 17h15 às 19h00. De sábado das 11h30 às 13h00 - Ampliação' FROM construcao c WHERE c.nome = 'Ampliação do Restaurante Universitário de São Carlos');  
...
INSERT INTO alimentacao (construcao_id, horario_funcionamento)
(SELECT construcao_id, 'Segunda à sexta-feira, das 11h00 às 13h30 e das 18h00 às 19h30 - RU' FROM construcao c WHERE c.nome = 'Restaurante Universitário - Araras'); 

/*A PARTIR DAQUI É REFERENTE AO CAMPUS SOROCABA*/ 

INSERT INTO alimentacao (construcao_id, horario_funcionamento)
(SELECT construcao_id, 'Segunda à sexta-feira, das 11h00 às 13h30 e das 17h30 às 19h00. Sábados das 11h00 às 13h00 - RU' FROM construcao c WHERE c.nome = 'Restaurante Universitário - Sorocaba'); 

INSERT INTO alimentacao (construcao_id, horario_funcionamento)
(SELECT construcao_id, 'Segunda à sexta-feira, das 11h00 às 13h30 e das 17h30 às 19h00. Sábados das 11h00 às 13h00 - Ampliação' FROM construcao c WHERE c.nome = 'Ampliação do Refeitório do RU'); 
