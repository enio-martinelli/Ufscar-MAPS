...
VALUES (SELECT prof_id, centro_id, '2018', '2022', 'diretora' FROM professor p, centro c WHERE p.nome = 'Maria da Graça Gama Melão', c.centor_id = 'CCBS'),
(SELECT prof_id, centro_id, '2018', '2022', 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Isabela Aparecida de Oliveira Lussi', c.centor_id = 'CCBS'),
(SELECT prof_id, centro_id, NULL, NULL, 'diretor' FROM professor p, centro c WHERE p.nome = 'Luiz Fernando de Oriani e Paulillo', c.centor_id = 'CCET'),
(SELECT prof_id, centro_id, NULL, NULL, 'vice-diretor' FROM professor p, centro c WHERE p.nome = 'Guillermo Antonio Lobos Villagra', c.centor_id = 'CCET'),
(SELECT prof_id, centro_id, '2018', '2022 ', 'diretor' FROM professor p, centro c WHERE p.nome = 'Rodrigo Vilela Rodrigues', c.centor_id = 'CCGT'),
(SELECT prof_id, centro_id, '2018', '2022 ', 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Monica Fabiana Bento Moreira Thiersch', c.centor_id = 'CCGT'),
(SELECT prof_id, centro_id, '2022', '2026 ', 'diretor' FROM professor p, centro c WHERE p.nome = 'André Cordeiro Alves dos Santos', c.centor_id = 'CCHB'),
(SELECT prof_id, centro_id, '2022', '2026 ', 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Maria Walburga dos Santos', c.centor_id = 'CCHB'),
(SELECT prof_id, centro_id, NULL, NULL, 'diretora' FROM professor p, centro c WHERE p.nome = 'Ana Lúcia Brandl', c.centor_id  = 'CCTS'),
(SELECT prof_id, centro_id, NULL, NULL, 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Marystela Ferreira', c.centor_id = 'CCTS'),
(SELECT prof_id, centro_id, '2020', '2024 ', 'diretora' FROM professor p, centro c WHERE p.nome = 'Ana Cristina Juvenal da Cruz', c.centor_id = 'CECH'),
(SELECT prof_id, centro_id, '2020', '2024 ', 'vice-diretor' FROM professor p, centro c WHERE p.nome = 'Adélcio Camilo Machado', c.centor_id = 'CECH'),
(SELECT prof_id, centro_id, NULL, NULL 'diretor' FROM professor p, centro c WHERE p.nome = 'Ricardo Toshio Fujihara', c.centor_id = 'CCA'),
(SELECT prof_id, centro_id, NULL, NULL 'vice-diretora' FROM professor p, centro c WHERE p.nome = 'Adriana Cavalieri Sais', c.centor_id = 'CCA'),
(SELECT prof_id, centro_id, NULL, NULL 'diretor' FROM professor p, centro c WHERE p.nome = 'Giulianna Rondineli Carmassi', c.centor_id = 'CCN'),
(SELECT prof_id, centro_id, NULL, NULL 'diretor' FROM professor p, centro c WHERE p.nome = 'Henrique Carmona Duval', c.centor_id = 'CCN');
...
VALUES (SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Marcos Arduin', d.dept_id = 'DB'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Leonardo Maurici Borges', d.dept_id = 'DB'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Andréa Lúcia Teixeira de Souza', d.dept_id = 'DCAm'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Victor Satoru Saito', d.dept_id = 'DCAm'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Wladimir Rafael Beck', d.dept_id = 'DCF'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Diana Amaral Monteiro', d.dept_id = 'DCF'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DEBE'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DEBE'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Patrícia Domingues de Freitas', d.dept_id = 'DGE'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Maria Teresa Marques Novo Mansur', d.dept_id = 'DGE'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Reinaldo José de Castro', d.dept_id = 'DHb'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Gilmar Perbiche Neves', d.dept_id = 'DHb'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Clovis Wesley Oliveira de Souza', d.dept_id = 'DMP'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Maíra Aparecida Stefanini', d.dept_id = 'DMP'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Daniela Godoi Jacomassi', d.dept_id = 'DEFMH'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Cleiton Augusto Libardi', d.dept_id = 'DEFMH'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Ariene Angelini dos Santos Orlandi', d.dept_id = 'DEnf'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Jamile Claro de Castro Bussadori', d.dept_id = 'DEnf'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Anna Carolyna L. Gianlorenço', d.dept_id = 'DFisio'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Luiz Fernando A. Selistre', d.dept_id = 'DFisio'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Amanda Dourado Souza Akahosi Fernandes', d.dept_id = 'DTO'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Lívia Celegati Pan', d.dept_id = 'DTO'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Silvana Gama Florêncio Chachá', d.dept_id = 'DMed'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Augustus Tadeu Relo de Mattos', d.dept_id = 'DMed'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Letícia Pimenta Costa-Guarisco', d.dept_id = 'DGero'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Juliana Hotta Ansai', d.dept_id = 'DGero'),
(SELECT prof_id, dept_id, 2021, 2022, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Valter Vieira de Camargo', d.dept_id = 'DC'),
(SELECT prof_id, dept_id, 2021, 2022, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Marcela Xavier Ribeiro', d.dept_id = 'DC'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Fernando Menezes de Almeida Filho', d.dept_id = 'DECiv'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Francis Massashi Kakuda', d.dept_id = 'DECiv'),
(SELECT prof_id, dept_id, 2022, 2024, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Robson Barcellos', d.dept_id = 'DEE'),
(SELECT prof_id, dept_id, 2022, 2024, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Helder Vinicius Avanço Galeti', d.dept_id = 'DEE'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Armando Ítalo Sette Antonialli', d.dept_id = 'DEMec'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'João Vitor de Carvalho Fontes', d.dept_id = 'DEMec'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Rodrigo Bresciani Canto', d.dept_id = 'DEMa'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Luiz Antonio Pessan', d.dept_id = 'DEMa'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Silvio Eduardo Alvarez Candido', d.dept_id = 'DEP'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Clarissa Fullin Barco de Camargo', d.dept_id = 'DEP'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Gabriela Cantarelli Lopes', d.dept_id = 'DEQ'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Rodrigo Béttega', d.dept_id = 'DEQ'),
(SELECT prof_id, dept_id, 2022, 2024, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Luis Ernesto Bueno Salasar', d.dept_id = 'DEs'),
(SELECT prof_id, dept_id, 2022, 2024, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Teresa Cristina Martins Dias', d.dept_id = 'DEs'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Emanuel Fernandes de Lima', d.dept_id = 'DF'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Francisco Ednilson Alves dos Santos', d.dept_id = 'DF'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DM'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DM'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Emerson Rodrigues de Camargo', d.dept_id = 'DQ'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Manoel Gustavo Petrucelli Homem', d.dept_id = 'DQ'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Neila Conceição Cunha Nardy', d.dept_id = 'DAdm-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Maria Cristina Comunian Ferraz', d.dept_id = 'DAdm-So'),
(SELECT prof_id, dept_id, 2021, 2023, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Siovani Cintra Felipussi', d.dept_id = 'DComp-So'),
(SELECT prof_id, dept_id, 2021, 2023, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Yeda Regina Venturini', d.dept_id = 'DComp-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Alexandre Lopes Gomes', d.dept_id = 'DEco-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Rosane Nunes de Faria', d.dept_id = 'DEco-So'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DEP-So'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DEP-So'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DBio-So'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DBio-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Juliana Rezende Torres', d.dept_id = 'DCHE-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Débora Dainez', d.dept_id = 'DCHE-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'José Marcos Nayme Novelli', d.dept_id = 'DGTH-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'José Eduardo de Salles Roselino Junior', d.dept_id = 'DGTH-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Augusto João Piratelli', d.dept_id = 'DCA-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Cláudio Roberto Thiersch', d.dept_id = 'DCA-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Johnny Vilcarromero Lopez', d.dept_id = 'DFQM-So'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Antonio Luis Venezuela', d.dept_id = 'DFQM-So'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DAC'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DAC'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Luciana de Souza Gracioso', d.dept_id = 'DCI'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Luzia Sigoli Fernandes Costa', d.dept_id = 'DCI'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Marcos Pazzanese Duarte Lanna', d.dept_id = 'DCSo'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Carolina Raquel Duarte de Mello Justo', d.dept_id = 'DCSo'),
(SELECT prof_id, dept_id, 2022, 2023, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Flavio Caetano da Silva', d.dept_id = 'DEd'),
(SELECT prof_id, dept_id, 2022, 2023, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Renata Maria Moschen Nascente', d.dept_id = 'DEd'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DFMC'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DFMC'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Camila da Silva Alavarce', d.dept_id = 'DL'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Rosa Yokota', d.dept_id = 'DL'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Joceli Catarina Stassi Sé', d.dept_id = 'DME'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Iraí Maria de Campos Teixeira', d.dept_id = 'DME'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Rosemeire de Araújo Rangni', d.dept_id = 'DPsi'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Elizabeth Joan Barham', d.dept_id = 'DPsi'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Fabiana Luci de Oliveira', d.dept_id = 'DS'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Aline Suelen Pires', d.dept_id = 'DS'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Andrea Braga Moruzzi', d.dept_id = 'DTPP'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Rebeca Chiacchio Azevedo Fernandes Galletti', d.dept_id = 'DTPP'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DDR'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DDR'),
(SELECT prof_id, dept_id, NULL, NULL, 'chefe' FROM professor p, departamento d WHERE p.nome = 'Josiane Rodrigues', d.dept_id = 'DTAiSER'),
(SELECT prof_id, dept_id, NULL, NULL, 'vice-chefe' FROM professor p, departamento d WHERE p.nome = 'Sabrina Gabardo', d.dept_id = 'DTAiSER'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DBPVA'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DBPVA'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DCNME'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DCNME'),
(NULL, SELECT dept_id, NULL, NULL, 'chefe' FROM departamento d WHERE d.dept_id = 'DRNPA'),
(NULL, SELECT dept_id, NULL, NULL, 'vice-chefe' FROM departamento d WHERE d.dept_id = 'DRNPA');
